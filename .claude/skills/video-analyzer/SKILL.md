...
```bash
${CLAUDE_SKILL_DIR}/scripts/extract_frames.sh <video_path> [output_dir] [fps]
```
...
**Example:**
```bash
${CLAUDE_SKILL_DIR}/scripts/extract_frames.sh /path/to/video.mp4
${CLAUDE_SKILL_DIR}/scripts/extract_frames.sh /path/to/video.mp4 ./my_frames
${CLAUDE_SKILL_DIR}/scripts/extract_frames.sh /path/to/video.mp4 ./my_frames 2  # 2 frames per second
```
...
1. Run `${CLAUDE_SKILL_DIR}/scripts/extract_frames.sh` on the video file
